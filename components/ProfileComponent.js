    ...
    return (
      ...
      <View style={styles.bodyContainer}>
        <View style={styles.userContainer}>
          ...
          <Text style={styles.welcomeText} >Chào mừng bạn đến với Pets Shop</Text>
          </View>
        </View>
        {/*  */}
      ...
      <ProfileItem name="Cài đặt" />*/}
        ...
        <Text style={[styles.itemText, {marginLeft: 20}]} onPress={()=>Linking.openURL('https://reactnavigation.org/docs/getting-started')} >Hỗ Trợ</Text>
        <FontAwesome name="angle-right" size={26} color="#1e1e1e" />
        </View>
